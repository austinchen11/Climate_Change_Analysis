...
g2 = ggplot(data = new_c02, aes(x = as.Date(Date), y = Value)) +
  geom_point() +
...
library(ggridges)
ggplot(data = df_temp_subset, aes(y= Country , x = Value)) + 
...
ggplot(data = interactive_sea_tidy, aes(y= Measure , x = Sea_lvl_change)) + 
  geom_density_ridges(alpha=0.5)
...
ggplot(data = temp_gdp_pollution, aes (x = Population, y = GDP)) +
  geom_point()
```
...
gridExtra::grid.arrange(i1, fig3_icevolume, nrow = 1)
